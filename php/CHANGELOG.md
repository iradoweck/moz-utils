...
- chore: Updated `composer.json` metadata.

## [0.3.8] - 2026-06-18
- chore(release): Bumped to 0.3.8 to match Absolute Parity logic.
- fix: Corrected the NUIT algorithm logic in PHP.
...
- feat: Implemented New CEP Engine for PHP (`isValidNewCEP`, `suggestCEPs`).
...
- test: Added native unit tests via PHPUnit.

## [0.1.0] - 2026-05-20
- feat: Initial PHP release.
