...
export default function Insights() {
  ...
  useEffect(() => {
    fetch('/stats.json')
      .then(r => {
        if (!r.ok) throw new Error('Local stats.json not found');
        return r.json();
      })
      .then(data => {
        setStats(data);
      ...
      .catch(() => {
        // Fallback para o de produção usando a API raw (evita bloqueios CORS locais)
        fetch('https://raw.githubusercontent.com/iradoweck/moz-utils/gh-pages/stats.json')
