...
function generateValidNUIT(first8) {
  ...
  const checkDigit = checkMap.charAt(remainder);
...
test('Tipo 1 → Pessoas Singulares', getNUITEntityType(nuitSingular), 'Pessoas Singulares');
test('Tipo 2 → Pessoas Singulares', getNUITEntityType(nuitSingular2), 'Pessoas Singulares');
test('Tipo 3 → Pessoas Singulares', getNUITEntityType(nuitEquivalent), 'Pessoas Singulares');
test('Tipo 4 → Pessoas Colectivas', getNUITEntityType(nuitCollective), 'Pessoas Colectivas');
test('Tipo 5 → Pessoas Colectivas', getNUITEntityType(nuitPublico), 'Pessoas Colectivas');
test('Tipo 6 → Entidades Equiparadas', getNUITEntityType(generateValidNUIT('60000000')), 'Entidades Equiparadas');
test('Tipo 7 → Estado / Públicas', getNUITEntityType(generateValidNUIT('70000000')), 'Estado / Públicas');
test('Tipo 8 → Outras Entidades', getNUITEntityType(generateValidNUIT('80000000')), 'Outras Entidades');
test('Tipo 9 → Entidades Estrangeiras', getNUITEntityType(generateValidNUIT('90000000')), 'Entidades Estrangeiras');
