# Changelog — Kotlin Stack

Change history for the **Kotlin/JVM** module of the `moz-utils` project.

---

## [0.3.9] - 2026-06-19
- chore: Refactored dummy strings to use `Formiga Antonio`.
- chore: Updated `build.gradle.kts` metadata.

## [0.3.8] - 2026-06-18
- chore(release): Bumped to 0.3.8 to match Absolute Parity logic.
- fix: Corrected the NUIT algorithm logic in Kotlin.
...
- feat: Implemented New CEP Engine for Kotlin (`isValidNewCEP`, `suggestCEPs`).
- feat: Added `getMobileWallet` to map Mozambican numbers to wallets.
...
## [0.1.1] - 2026-05-22
- test: Added native unit tests via JUnit.
- chore: Prepared publication metadata for JitPack/Maven.

## [0.1.0] - 2026-05-20
- feat: Initial Kotlin JVM release.
